...
import static com.wx.wxrecyclerview.view.RefreshLayout.RefreshState.PULL_DOWN;
import static com.wx.wxrecyclerview.view.RefreshLayout.RefreshState.PULL_TO_REFRESH;
import static com.wx.wxrecyclerview.view.RefreshLayout.RefreshState.PULL_UP;
import static com.wx.wxrecyclerview.view.RefreshLayout.RefreshState.REFRESHING;
import static com.wx.wxrecyclerview.view.RefreshLayout.RefreshState.RELEASE_TO_REFRESH;
...
public abstract class RefreshLayout<T extends RecyclerView> extends LinearLayout{
    ...
    private void measureView(View view){
        ...
        if (lpHeight > 0) {
            ...
            childHeightSpec = MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED);      //是未指定尺寸，这种情况不多，一般都是父控件是AdapterView
        }
